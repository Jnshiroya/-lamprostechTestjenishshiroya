...
vector<int> checkValidOrder(int numCourses, vector<pair<int, int>> &prerequisites)
{
...
int main()
{
    ...
    vector<pair<int, int>> input_course = {{0, 1}, {1, 2}, {2, 3}, {3, 0}}; // with cycle
    // vector<pair<int, int>> input_course = {{0, 1}, {1, 2}, {2, 3}};         // without cycle

    // Call the function for find the order of the courses
    vector<int> courseOrder = checkValidOrder(numCourses, input_course);
